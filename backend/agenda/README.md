...
You should see messages similar to the following:
    ...
    INFO  [br.unifor.progweb.agenda.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [br.unifor.progweb.agenda.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
